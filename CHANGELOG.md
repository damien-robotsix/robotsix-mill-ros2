...
* **ci:** scope release-please permissions at the job so the reusable workflow can start ([#159](https://github.com/damien-robotsix/robotsix-mill-ros2/issues/159)) ([bd00f86](https://github.com/damien-robotsix/robotsix-mill-ros2/commit/bd00f86124985977b095e8054617b1fb70e825b4))
...
- Sync CI matrix tool versions with pre-commit hook revisions: codespell 2.4.2→2.4.3, markdownlint-cli 0.49.0→0.49.1
- Pin vcs2l to 1.1.7 in the pre-commit CI job to match the VCS Validate matrix job and devcontainer
